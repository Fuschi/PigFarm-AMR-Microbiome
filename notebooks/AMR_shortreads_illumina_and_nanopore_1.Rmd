...
df_stats %>%
  unite("TecnologyCountry", c(Tecnology, Country), sep = "_", remove = FALSE) %>%
  filter(stat %in% c("detection","sumCount")) %>%
  ggplot(aes(x = value, fill = TecnologyCountry)) +
