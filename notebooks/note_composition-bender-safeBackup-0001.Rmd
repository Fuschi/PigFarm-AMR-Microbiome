...
```{r}
bac_reads_gen %>%
  mutate(genus_fct = if_else(highlight, genus, "Others")) %>%
...
```{r}
bac_reads_fam %>%
  mutate(family_fct = if_else(highlight, family, "Others")) %>%
...
```{r}
bac_reads_phy %>%
  mutate(phylum_fct = if_else(highlight, phylum, "Others")) %>%
...
```{r}
write_tsv(bac_reads_gen, "../tables/comp_bac_read_genus.tsv")
write_tsv(bac_reads_fam, "../tables/comp_bac_read_family.tsv")
write_tsv(bac_reads_phy, "../tables/comp_bac_read_phylum.tsv")
write_tsv(arg_reads_abf, "../tables/comp_arg_read_abf.tsv")
write_tsv(arg_contigs_abf, "../tables/comp_arg_contig_abf.tsv")
write_tsv(arg_contigs_gen, "../tables/comp_arg_contig_genus.tsv")
write_tsv(arg_contigs_fam, "../tables/comp_arg_contig_family")
write_tsv(arg_contigs_phy, "../tables/comp_arg_contig_phylum.tsv")
```
